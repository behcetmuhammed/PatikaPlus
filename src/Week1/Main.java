...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Matematik sonucunu giriniz: ");
        double Matematik = input.nextDouble();
        System.out.println("Fizik sonucunu giriniz: ");
        double Fizik = input.nextDouble();
        System.out.println("Kimya sonucunu giriniz: ");
        double Kimya = input.nextDouble();
        System.out.println("Türkçe sonucunu giriniz: ");
        double Türkçe = input.nextDouble();
        System.out.println("Tarih sonucunu giriniz: ");
        double Tarih = input.nextDouble();
        System.out.println("Müzik sonucunu giriniz: ");
